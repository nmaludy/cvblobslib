...
void RegistraTotsOperadors( t_OperadorBlobFactory &fabricaOperadorsBlob )
{
	...
	fabricaOperadorsBlob.Register( CBlobGetRelativeArea().GetNom(), Type2Type<CBlobGetRelativeArea>());
	...
	fabricaOperadorsBlob.Register( CBlobGetReferencedMean(NULL,0).GetNom(), Type2Type<CBlobGetReferencedMean>());
